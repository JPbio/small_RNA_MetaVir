...
dir_aux_lib_root="/media/data8/hebert/srna/asset/libs/SRA_smallRNA/r2d2"
...
do
    ...
    do
        ...
        path_input="$dir_aux_lib_root/$batch_name/$path_input_base"
        ...
        # dir_aux_lib_root="/media/data8/hebert/srna/asset/libs/SRA_smallRNA/r2d2/batch-07/ran"
        # path_input2="$dir_aux_lib_root/$path_input_base"

        # echo "path_input2: '$path_input2'"
        # if [ -f "$path_input2" ]; then
        if [ -f "$path_input" ]; then
            # input_size_line=`du $path_input2`
